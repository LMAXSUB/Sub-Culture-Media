...
```html
<script data-goatcounter="https://subxculturex.goatcounter.com/count" async src="//gc.zgo.at/count.js"></script>
```
...
- **Analytics**: sign up at goatcounter.com, create a site, and replace
  `subxculturex` in the script tag above with your real site code (it appears
  on every page as a placeholder right now).
